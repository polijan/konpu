...
//------------------------------------------------------------------------------
// Provide a simple do-nothing implementation of the Core functions that would
// normally be implemented in a backend.
//------------------------------------------------------------------------------
...
// App
void *AppLoad(const char* app_name)    { (void)app_name; return NULL; }
int   AppUnload(void *app_handle)      { (void)app_handle; return 0; }
...
#endif
int Printer(const char *restrict format, ...)    { (void)format; return 0; }
